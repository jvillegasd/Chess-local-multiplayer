...
public class VentanaJuegoCliente extends javax.swing.JFrame {
    ...
    private static JButton botonEnviar = new JButton("Enviar");
        ...
        botonEnviar.addMouseListener(new MouseListener() { //Asignarle un MouseListener al JButton.
            ...
            public void mouseReleased(MouseEvent e) {
                try {
                    ...
                    chatVisual.append("\n Negras: " + chatEscritura.getText());
                    chatEscritura.setText("");
                    dataSaliente.writeUTF(mensajeSaliente);
                } catch (Exception ex) {
                }
            }
    ...
    public void iniciarConexion(String Ip, int puerto) {
        ...
        hiloChat = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    socket = new Socket(Ip, puerto); //IP del servidor con su respectivo puerto para chat
        ...
        hiloMov = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    socketJ = new Socket(Ip, 9999); //IP del servidor con su respectivo puerto para turnos
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaJuegoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
